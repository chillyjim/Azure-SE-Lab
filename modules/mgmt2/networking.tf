...
resource "azurerm_subnet" "mgrnet" {
  name                 = var.mgrnet                          # Subnet name as passed to the module
  resource_group_name  = azurerm_resource_group.rg.name      # Name of existing vnet
  virtual_network_name = azurerm_virtual_network.vnet.name   # Name of the existing vnat
